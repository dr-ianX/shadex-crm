...
const mockTransformations: MockTransformation[] = [
  {
    id: '1',
...
export const transformationController = {
  ...
  getAllTransformations: async (req: Request, res: Response) => {
    try {
  ...
  getTransformationById: async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
  ...
  createTransformation: async (req: Request, res: Response) => {
    try {
  ...
  updateTransformation: async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
  ...
  deleteTransformation: async (req: Request, res: Response) => {
    try {
      const { id } = req.params;
      const index = mockTransformations.findIndex(t => t.id === id);
