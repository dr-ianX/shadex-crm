...
import { D as styleFunctionSx, F as init_createSpacing, G as createBreakpoints, K as init_createBreakpoints, O as defaultSxConfig, Ot as _extends, P as createSpacing, Q as GlobalStyles, St as require_prop_types, Tt as deepmerge, _t as resolveProps, at as ThemeContext$1, ct as DefaultPropsProvider, dt as init_objectWithoutPropertiesLoose, ft as init_clamp, g as require_colorManipulator, i as createTheme, kt as init_extends, n as defaultTheme, pt as clamp, q as init_styled_engine, s as createTypography, t as identifier_default, ut as _objectWithoutPropertiesLoose, v as init_styleFunctionSx, wt as init_deepmerge } from "./identifier-Bk70jiYx.js";
import { i as init_getDisplayName } from "./styled-DOdUVDBc.js";
import { n as useTheme$2, r as useTheme$3, t as GlobalStyles$1 } from "./esm-BEt3dPTt.js";
...
function RtlProvider(_ref) {
	let { value } = _ref, props = _objectWithoutPropertiesLoose(_ref, _excluded$5);
...
function createCssVarsProvider(options) {
	...
	function CssVarsProvider(props) {
		...
		const _ref = scopedTheme || themeProp, { colorSchemes = {}, components = {}, generateCssVars = () => ({
			vars: {},
			css: {}
		}), cssVarPrefix } = _ref, restThemeProp = _objectWithoutPropertiesLoose(_ref, _excluded$4);
		...
		const element = /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(import_react.Fragment, { children: [shouldGenerateStyleSheet && /*#__PURE__*/ (0, import_jsx_runtime.jsxs)(import_react.Fragment, { children: [
			/*#__PURE__*/ (0, import_jsx_runtime.jsx)(GlobalStyles, { styles: { [colorSchemeSelector]: rootCss } }),
			/*#__PURE__*/ (0, import_jsx_runtime.jsx)(GlobalStyles, { styles: defaultColorSchemeStyleSheet }),
			/*#__PURE__*/ (0, import_jsx_runtime.jsx)(GlobalStyles, { styles: otherColorSchemesStyleSheet })
...
function prepareCssVars(theme, parserConfig) {
	...
	const { vars: rootVars, css: rootCss, varsWithDefaults: rootVarsWithDefaults } = cssVarsParser(_objectWithoutPropertiesLoose(theme, _excluded$3), parserConfig);
...
//#endregion
export { lighten as A, darken as C, getLuminance as D, getContrastRatio as E, useId as F, useEnhancedEffect as I, exactProp as L, rgbToHex as M, useThemeProps$1 as N, hexToRgb as O, getThemeProps as P, alpha as S, emphasize as T, toUnitless as _, excludeVariablesFromRoot as a, adaptV4Theme as b, shouldSkipGeneratingVar as c, makeStyles as d, ThemeProvider as f, getUnit as g, responsiveFontSizes as h, useColorScheme as i, recomposeColor as j, hslToRgb$1 as k, withTheme as l, useTheme as m, CssVarsProvider as n, extendTheme as o, useThemeProps as p, getInitColorSchemeScript as r, getOverlayAlpha as s, experimental_sx as t, withStyles as u, createStyles as v, decomposeColor as w, useRtl as x, createMuiStrictModeTheme as y };
